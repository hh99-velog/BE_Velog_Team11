...
public enum ErrorCode {
    ...
    ERROR_USER_ID(400,"유저 정보가 존재하지 않습니다."),
    ...
    ERROR_DUPLICATE_EMAIL(400,"이메일 중복 입니다"),
    ERROR_DUPLICATE_NICKNAME(400,"닉네임 중복입니다"),
    ERROR_TYPE_EMAIL(400,"이메일 형식이 아닙니다."),
    ERROR_TYPE_NICKNAME(400,"닉네임 형식은 영대소문자한글,숫자 3-10자 이내"),
    ERROR_TYPE_PASSWORD(400,"비밀번호 형식은 영대소문,숫자 4-12 이내 입니다"),

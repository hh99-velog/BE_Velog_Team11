...
import com.example.be_velog_team11.security.jwt.JwtPreProcessingToken;
 ...
 */
/*
JWTAuthFilter: API 요청 Header 에 전달되는 JWT 토큰 유효성 인증
 */
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    // ** 6. 인증 시도하면 Header 에  Authorization 확인 **
    @Override
    public Authentication attemptAuthentication(
        ...
        // 추출한 JWT 담아서 스프링 시큐리티로 넘김 -> JwtAuthProvider
        return super
